...
import javax.swing.*;
public class GrabFare extends cal{

    cal cll = new cal(fare, discount, cash, ownmoney);
    ...
    GrabFare(int fare,double discount,double cash,double ownmoney) {
        ...
        JButton bconfirm,bback,bclear,bnext;
